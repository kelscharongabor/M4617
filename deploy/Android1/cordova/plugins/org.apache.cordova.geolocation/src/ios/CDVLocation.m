...
- (BOOL)isAuthorized
{
    BOOL authorizationStatusClassPropertyAvailable = TRUE; //[CLLocationManager respondsToSelector:@selector(authorizationStatus)]; // iOS 4.2+
...
- (void)startLocation:(BOOL)enableHighAccuracy
{
    ...
    if (![self isAuthorized]) {
        ...
        BOOL authStatusAvailable = TRUE; //[CLLocationManager respondsToSelector:@selector(authorizationStatus)]; // iOS 4.2+
